                ...
                <div className="container my-4">
                    <div className="row">
                        <div className="col-sm-6 mx-auto col-md-4">
                            <h1 className="text-center login-title">Register to continue to Roommate Website</h1>
                            <div className="account-wall">
                                <img className="profile-img" src="//lh3.googleusercontent.com/-6V8xOA6M7BA/AAAAAAAAAAI/AAAAAAAAAAA/rzlHcD0KYwo/photo.jpg?sz=120"
                                    alt=""/>
